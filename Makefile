...
dep_emq_reloader  = git https://github.com/emqtt/emq-reloader v2.3.3

# emq auth/acl plugins
dep_emq_auth_clientid = git https://github.com/emqtt/emq-auth-clientid v2.3.3
dep_emq_auth_username = git https://github.com/emqtt/emq-auth-username v2.3.3
dep_emq_auth_ldap     = git https://github.com/emqtt/emq-auth-ldap v2.3.3
...
dep_emq_sn    = git https://github.com/emqtt/emq-sn v2.3.3
dep_emq_coap  = git https://github.com/emqtt/emq-coap v2.3.3
dep_emq_stomp = git https://github.com/emqtt/emq-stomp v2.3.3

# plugin template
dep_emq_plugin_template = git https://github.com/emqtt/emq-plugin-template v2.3.3

# web_hook lua_hook
dep_emq_web_hook  = git https://github.com/emqtt/emq-web-hook v2.3.3
dep_emq_lua_hook  = git https://github.com/emqtt/emq-lua-hook v2.3.3
